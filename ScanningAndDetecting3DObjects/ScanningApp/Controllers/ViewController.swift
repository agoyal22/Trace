...
class ViewController: UIViewController, ARSCNViewDelegate, ARSessionDelegate, UIDocumentPickerDelegate {
    ...
    func createAndShareReferenceObject() {
        ...
        //print("asdfghjkjfdsdfghjkjhgfdsdfghjhgfdsdfghjkjhgfd")
        print(object.extent)
        let rawPoints = object.rawFeaturePoints
        let points = rawPoints.points
        ...
        //print(extent)
        //print(scale)
        let dimension = extent*scale
        let dimensionArray = [dimension.x, dimension.y, dimension.z]
        ...
        if dimension.x > dimension.y && dimension.x > dimension.z{
            ...
            largD = dimension.y
        } else if dimension.z > dimension.x && dimension.z > dimension.y{
            largD = dimension.z
        }
        ...
        if largD >= 0.3096{
            shoeSize = "15.0"
        } else if largD >= 0.3016{
            shoeSize = "14.0"
        } else if largD >= 0.2937{
            shoeSize = "13.0"
        } else if largD >= 0.2858{
            shoeSize = "12.0"
        } else if largD >= 0.2826{
            shoeSize = "11.5"
        } else if largD >= 0.2778{
            shoeSize = "11.0"
        } else if largD >= 0.2731{
            shoeSize = "10.5"
        } else if largD >= 0.2683{
            shoeSize = "10.0"
        } else if largD >= 0.2651{
            shoeSize = "9.5"
        } else if largD >= 0.2604{
            shoeSize = "9.0"
        } else if largD >= 0.2572{
            shoeSize = "8.5"
        } else if largD >= 0.2524{
            shoeSize = "8.0"
        } else if largD >= 0.2477{
            shoeSize = "7.5"
        } else if largD >= 0.2445{
            shoeSize = "7.0"
        } else if largD >= 0.2413{
            shoeSize = "6.5"
        } else if largD >= 0.2350{
            shoeSize = "6"
        } else{
            shoeSize = "Error: rescan"
        }
        var title = "Shoe Size:"
        var message = shoeSize
